 ...
 */
class workflowpakbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "workflowpak@workflowpak";
    public $boxlabel;
    public $depends = array("workflowpak");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/workflowpak/class/workflowpak.class.php";
